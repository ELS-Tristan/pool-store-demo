...
function AboutUs() {
    ...
    return (
        <main className="main about-us">
            <Helmet>
                <title>Pool Store | Services</title>
            </Helmet>

            <h1 className="d-none">Pool Store - Services</h1>
            ...
            <div className="page-header pl-4 pr-4"
                style={{ backgroundImage: `url( ./images/page-header/services-banner.png )`, backgroundColor: "#3C63A4" }}>
                <h3 className="page-subtitle font-weight-bold">Welcome to Pool Store</h3>
                <h1 className="page-title font-weight-bold lh-1 text-white text-capitalize">Our Services</h1>
                <p className="page-desc text-white mb-0">We provide pool and spa cleaning and repair services<br /> along with all the parts and equipment you need.</p>
            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-4 mb-4">
                                            <div className="counter text-center text-dark">
                                                ...
                                                <h5 className="count-title font-weight-bold text-body ls-md">Pools and Spas Serviced</h5>
                                                <p className="text-grey mb-0">Cleanings, repairs, and <br />green-to-clean services to make sure your summer is nice.</p>
                                            </div>
                                        </div>
                                        <div className="col-md-4 mb-4">
                                            <div className="counter text-center text-dark">
                                                ...
                                                <h5 className="count-title font-weight-bold text-body ls-md">Parts Available</h5>
                                                <p className="text-grey mb-0">Pool Store has all<br />the parts needed to get your system running perfectly.</p>
                                            </div>
                                        </div>
                                        <div className="col-md-4 mb-4">
                                            <div className="counter text-center text-dark">
                                                ...
                                                <p className="text-grey mb-0">Our knowledgeable staff<br />is ready to help you.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-md-7 mb-4">
                                    <figure>
                                        <LazyLoadImage
                                            src="./images/subpages/poolrest1.jpg"
                                            alt="Happy Customer"
                                            width="580"
                                            height="507"
                                            effect="opacity"
                                ...
                                <div className="col-md-5 mb-4">
                                    ...
                                    <h3 className="section-title lh-1 font-weight-bold">Provide quality and<br />qualifed products<br />and services</h3>
                                    <p className="section-desc text-grey">
                                        Already hundreds of households are very satisfied by our services.<br />
                                        Creating a wonderful swimming experience is what we do best<br />
                                    </p>
                                    <ALink href="/shop" className="btn btn-dark btn-link btn-underline ls-m">Visit Our Store<i className="d-icon-arrow-right"></i></ALink>
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-md-6 order-md-first mb-4">
                                    <h5 className="section-subtitle lh-2 ls-md font-weight-normal mb-1">03. Pool and Spa Repairs</h5>
                                    ...
                                    <ALink href="/pages/contact-us" className="btn btn-dark btn-link btn-underline ls-m">Get in touch!<i className="d-icon-arrow-right"></i></ALink>
                                </div>

                                <div className="col-md-6 mb-4">
                                    <figure>
                                        <LazyLoadImage
                                            src="./images/subpages/elijahClean1.png"
                                            alt="Filter Cleans"
                                            width="580"
                                            height="507"
                                            effect="opacity"
